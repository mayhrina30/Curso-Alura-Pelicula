...
public class Principal {
    public static void main(String[] args) {
        ...
        filtroRecomendacion.filtra(episodio);
         ...
         var peliculadeMayra = new Pelicula();
         peliculadeMayra.setNombre("El señoer de los añillo");
         peliculadeMayra.setDuracionEnMinutos(100);
         peliculadeMayra.setFechaDeLanzamiento(2001);


        ArrayList<Pelicula>ListadePelicula = new ArrayList<>();
        ListadePelicula.add(peliculadeMayra);
